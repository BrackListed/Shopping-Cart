...
export function ProductUI({productClicked, setproductClicked, setAddedProduct}: MainProps) {
    ...
    <div>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm p-4">
            ...
            <div>       
                <h2 className="text-2xl font-bold text-zinc-950 pr-8 truncate">{selectedProduct?.title}</h2>
            </div>
        ...
        {/* Display products */}
        <div className="flex gap-3 w-382 flex-wrap">{mockProducts.map((product: ProductTypeTest) => (
